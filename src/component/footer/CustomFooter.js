...
import { FacebookFilled, TwitterSquareFilled, LinkedinFilled, YoutubeFilled } from '@ant-design/icons';
      ...
      <div className="footer__top">
        <Row className="footer__top__area">
          <Col className="ant-col-xs-24 ant-col-md-24 ant-col-lg-15 ant-col-xl-15 footer__top__area--left">
            <h2 className="footer__top__area--left--heading heading heading-two">MyHappyFund</h2>
          ...
          <Col className="footer__top__area--right ant-col-xs-24 ant-col-md-24 ant-col-lg-9 ant-col-xl-9">
            <Row className="footer__top__area--right--nav">
              <Col className="ant-col-xs-24 ant-col-md-24 ant-col-lg-8 ant-col-xl-8 footer__top__area--right--nav-section">
                <p className="footer__top__area--right--nav-section--heading">Quick Links</p>
                <ul>
                  <li>Home</li>
                  <li>Campaigns</li>
                  <li>About</li>
              ...
              <Col className="ant-col-xs-24 ant-col-md-24 ant-col-lg-8 ant-col-xl-8  footer__top__area--right--nav-section">
                <p className="footer__top__area--right--nav-section--heading">Membership</p>
                <ul>
                  <li>Sttart A Campaign</li>
                  <li>Donate Now</li>
                </ul>
              </Col>
              <Col className="ant-col-xs-24 ant-col-md-24 ant-col-lg-8 ant-col-xl-8  footer__top__area--right--nav-section">
                <p className="footer__top__area--right--nav-section--heading">Get Connected</p>
                <ul className="footer__top__area--right--nav-section--social">
                  <li><FacebookFilled /></li>
                  <li><TwitterSquareFilled /></li>
      ...
      <div className="footer__bottom">
        <Row className="footer__bottom__area">
          <Col className="ant-col-xs-24 ant-col-md-24 ant-col-lg-18 ant-col-xl-18 footer__bottom__area--left">
            <p className="footer-area__bottom__area--left--note">© All rights reserved - MyHappyFund</p>
          </Col>
