            ...
            <div className="main__section how-it-works__area">
                <Row className="how-it-works__area--top main__section--header">
                    <Col className="ant-col-xs-24 ant-col-md-24 ant-col-lg-18 ant-col-xl-18 ant-col-xxl-12  how-it-works__area--top-text">
                        ...
                        <Text className="how-it-works__area--top-text--sub-heading sub-heading">Lorem ipsum dolor sit amet, consectetur adipiscing elit.Curabitur sit amet eros blandit, hendrerit elit et, mattis purus.</Text>
                    </Col>
                </Row>
                <Row gutter={[32, 32]} className="how-it-works__area--bottom">
                    <Col className="ant-col-xs-24 ant-col-md-12 ant-col-lg-8 ant-col-xl-8 how-it-works__area--bottom--col">
